...
public final class TexturePanel extends Panel {
	...
	public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
		...
		RenderHelper.drawScrollingString(poseStack, parent.font(), new TextComponent(TailsComponents.getSubTypeName(partInfo)), left + 25, right - 25, variantSelectY + 4, 0xFFFFFFFF);
		RenderHelper.drawScrollingString(poseStack, parent.font(), new TextComponent(TailsComponents.getTextureName(partInfo)), left + 25, right - 25, texSelectY + 4, 0xFFFFFFFF);
	}
