...
public final class TexturePanel extends Panel {
	...
	public void renderWidget(GuiGraphics gui, int mouseX, int mouseY, float partialTick) {
		...
		RenderHelper.drawScrollingString(gui, parent.font(), Component.literal(TailsComponents.getSubTypeName(partInfo)), left + 25, right - 25, variantSelectY + 4, 0xFFFFFF);
		RenderHelper.drawScrollingString(gui, parent.font(), Component.literal(TailsComponents.getTextureName(partInfo)), left + 25, right - 25, texSelectY + 4, 0xFFFFFF);
	}
