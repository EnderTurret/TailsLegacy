...
import net.enderturret.tailslegacy.neoforge.client.render.BotaniaFoxtatoRenderer;
import net.enderturret.tailslegacy.neoforge.client.render.PartPreviewRenderState;
import net.enderturret.tailslegacy.neoforge.client.render.PartPreviewRenderer;
import net.enderturret.tailslegacy.neoforge.client.render.layer.PartLayer;
import net.enderturret.tailslegacy.neoforge.client.render.layer.TailsArrowLayer;
import net.enderturret.tailslegacy.neoforge.mixin.client.LivingEntityRendererAccess;
