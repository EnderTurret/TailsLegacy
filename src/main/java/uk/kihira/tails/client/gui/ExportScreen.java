...
class ExportScreen extends BaseScreen {
	...
	ExportScreen(EditorScreen parent, PartsData partsData) {
	...
	public void init() {
		// Left
		addButton(new TooltipButton(20, height - 90, 130, 20, new TranslationTextComponent("gui.button.export.userdir"),
				minecraft.getMainWindow().getScaledWidth() / 2, b -> handleExport(0), font, new TranslationTextComponent("gui.button.export.tooltip", System.getProperty("user.home"))));
		addButton(new TooltipButton(20, height - 65, 130, 20, new TranslationTextComponent("gui.button.export.minecraftdir"),
				minecraft.getMainWindow().getScaledWidth() / 2, b -> handleExport(1), font, new TranslationTextComponent("gui.button.export.tooltip", System.getProperty("user.dir"))));
		addButton(new TooltipButton(20, height - 40, 130, 20, new TranslationTextComponent("gui.button.export.custom"),
				minecraft.getMainWindow().getScaledWidth() / 2, b -> handleExport(2), font, new TranslationTextComponent("gui.button.export.custom.tooltip")));

		// Right
		addButton(openFolderButton = new TooltipButton(width - 150, height - 65, 130, 20, new TranslationTextComponent("gui.button.openfolder"),
				...
				}, font, new TranslationTextComponent("gui.button.openfolder.tooltip")));
		openFolderButton.visible = exportMessage != null;

		addButton(new TooltipButton(width - 150, height - 40, 130, 20, new TranslationTextComponent("gui.button.upload"),
				minecraft.getMainWindow().getScaledWidth() / 2, b -> {
					...
					runnable.run();
				}, font, new TranslationTextComponent("tails.upload.tooltip")));
	}
