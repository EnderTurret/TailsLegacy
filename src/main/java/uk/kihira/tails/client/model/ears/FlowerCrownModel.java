...
final class FlowerCrownModel extends PartModel {
	...
	public FlowerCrownModel() {
		...
		final PartDefinition vine = rootDef.addOrReplaceChild("vine", CubeListBuilder.create()
				.texOffs(5, 11).addBox(-2F, -7F, -5F, 4F, 1F, 1F)
				.texOffs(0, 5).addBox(-4.9F, -5F, -2F, 1F, 1F, 4F)
				.texOffs(0, 0).addBox(3.9F, -5F, -2F, 1F, 1F, 4F)
				.texOffs(9, 9).addBox(-2F, -3F, 3.9F, 4F, 1F, 1F), PartPose.ZERO);
		...
		vine.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 14).addBox(0F, -7F, -4.9F, 3F, 1F, 1F), PartPose.rotation(0F, 0F, 0.2618F));

		vine.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(14, 7).addBox(-3F, -7F, -4.9F, 3F, 1F, 1F), PartPose.rotation(0F, 0F, -0.2618F));

		final PartDefinition flower = rootDef.addOrReplaceChild("flower", CubeListBuilder.create().texOffs(14, 12).addBox(2F, -7F, -5.4F, 1F, 1F, 1F), PartPose.ZERO);
		...
		final PartDefinition flower2 = rootDef.addOrReplaceChild("flower2", CubeListBuilder.create().texOffs(0, 7).addBox(-0.5F, -0.5015F, -0.2606F, 1F, 1F, 1F), PartPose.offset(-2F, -6.9985F, -5.1394F));
		...
		final PartDefinition flower3 = rootDef.addOrReplaceChild("flower3", CubeListBuilder.create().texOffs(0, 5).addBox(-0.2F, -0.5015F, -0.4606F, 1F, 1F, 1F), PartPose.offset(-5.2F, -5.1985F, -2.1394F));
		...
		final PartDefinition flower4 = rootDef.addOrReplaceChild("flower4", CubeListBuilder.create().texOffs(0, 2).addBox(-0.8F, -0.5015F, -0.4606F, 1F, 1F, 1F), PartPose.offset(5.2F, -4.6985F, 0.2606F));
		...
		final PartDefinition flower5 = rootDef.addOrReplaceChild("flower5", CubeListBuilder.create().texOffs(0, 0).addBox(2F, -7F, 4.4F, 1F, 1F, 1F), PartPose.offset(-1.6F, 3.3F, 0F));
