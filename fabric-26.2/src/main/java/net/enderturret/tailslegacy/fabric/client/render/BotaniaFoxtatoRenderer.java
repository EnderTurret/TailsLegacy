...
public final class BotaniaFoxtatoRenderer {
	...
	public static void render(PoseStack poseStack, SubmitNodeCollector collector, BlockPos pos, float partialTicks, int packedLight, int packedOverlay) {
		if (renderer == null) renderer = new FoxtatoRenderer();

		renderer.render((TailsPoseStack) poseStack, (TailsBufferSource) collector, pos.getX(), pos.getY(), pos.getZ(), partialTicks, packedLight, packedOverlay);
	}
