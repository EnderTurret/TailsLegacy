...
public final class FoxtatoRenderer {
	...
	public FoxtatoRenderer() {
		this(List.of(
				new ClientPartInfo(new int[]{-5480951, -6594259, -5197647}, PartRegistry.FLUFFY_TAIL),
				new ClientPartInfo(new int[]{-5480951, 0xFF000000, -5197647}, PartRegistry.FOX_EARS)));
	}
